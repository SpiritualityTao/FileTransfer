...
public class WifiUtils {
    ...
    private WifiUtils(Context context){
        ...
        this.mWifiManager = (WifiManager) context.getSystemService(Context.WIFI_SERVICE); //获得WifiManager
    }
    ...
    public void startScan(){
        ...
        Log.i(TAG, "startScan: " + mScanResultList.toString());
...
//  when connect the hotspot, is still returning "0.0.0.0".
    ...
    public boolean isCurrentWifi(List<String> SSIDs){
        boolean isContains = false;
        WifiInfo wifiInfo = mWifiManager.getConnectionInfo();
        Log.i(TAG, "isCurrentWifi: " + wifiInfo.getSSID());
        Log.i(TAG, "SSID: " + SSIDs.toString());
        for (int i = 0; i < SSIDs.size(); i++) {
            if (wifiInfo.getSSID() != null && wifiInfo.getSSID().equals("\""+SSIDs.get(i) + "\"")) {
                Log.i(TAG, "isCurrentWifi: " + true);
                isContains = true;
            }
        }
        return  isContains;
